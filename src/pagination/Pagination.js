...
export default class Pagination extends PureComponent {
    ...
    static propTypes = {
        ...
        containerStyle: ViewPropTypes ? ViewPropTypes.style : View.propTypes ? View.propTypes.style : PropTypes.object,
        dotColor: PropTypes.string,
        dotContainerStyle: ViewPropTypes ? ViewPropTypes.style : View.propTypes ? View.propTypes.style : PropTypes.object,
        dotElement: PropTypes.element,
        dotStyle: ViewPropTypes ? ViewPropTypes.style : View.propTypes ? View.propTypes.style : PropTypes.object,
        inactiveDotColor: PropTypes.string,
        inactiveDotElement: PropTypes.element,
        inactiveDotOpacity: PropTypes.number,
        inactiveDotScale: PropTypes.number,
        inactiveDotStyle: ViewPropTypes ? ViewPropTypes.style : View.propTypes ? View.propTypes.style : PropTypes.object,
